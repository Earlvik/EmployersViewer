...
<head>
    ...
    <script src="/resources/newEmployerViewer.js"></script>
</head>
<body>
<div class="container">
    <div class="row">
        <div class="span8 offset2">
            ...
            <form:form  id="newEmployerForm" action="${pageContext.request.contextPath}/add.json" commandName="employer" class="form-horizontal">
